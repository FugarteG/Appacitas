...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<MemberUpdateDto> GetMemberAsync(string username)
        {
        ...
        public async Task<PagedList<MemberUpdateDto>> GetMembersAsync(UserParams userParams)
        {
            ...
            return await PagedList<MemberUpdateDto>.CreateAsync(query.ProjectTo<MemberUpdateDto>(_mapper
